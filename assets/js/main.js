...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    //>> Active Js Start <<//
    $(".contact-info-items").hover(function () {
    ...
    const testimonialContentSlider2 = new Swiper(
      ".testimonial-content-slider-2",
      {
        spaceBetween: 30,
        speed: 1000,
        loop: "true",
    ...
    const testimonialContentSlider3 = new Swiper(
      ".testimonial-content-slider-3",
      {
        spaceBetween: 30,
        speed: 1000,
        loop: "true",
    ...
    //>> Food Catagory Slider Start <<//
    const todayBestSaleImageSlider = new Swiper(
      ".today-best-sale-image-slider",
      {
        loop: "true",
        speed: 3000,
        autoplay: {
    ...
    if ($(".testimonial-section .fry-shape").length > 0) {
      ...
      testimonialSection.to(".testimonial-section .fry-shape", {
        yPercent: 100,
        ease: "none",
      });
      testimonialSection.to(".testimonial-section .pizza-shape", {
        rotation: 360,
        duration: 3,
      });
      testimonialSection.to(".testimonial-section .burger-shape", {
        rotation: 270,
        duration: 3,
      });
    }
    ...
    if ($(".food-category-section .burger-shape-2").length > 0) {
      ...
      categoryFood.to(".food-category-section .tomato-shape", {
        yPercent: -40,
        ease: "none",
      });
      categoryFood.to(".food-category-section .burger-shape-2", {
        xPercent: 100,
        ease: "none",
      });
    }
    ...
    if ($(".news-section .burger-shape").length > 0) {
      ...
      newsShape.to(".news-section .burger-shape", {
        yPercent: 130,
        ease: "none",
      });
