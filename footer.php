     ...
     <div class="container">
         <div class="footer-widgets-wrapper">
             <div class="row">
                 <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4 wow fadeInUp" data-wow-delay=".2s">
                     <div class="single-footer-widget">
                         ...
                         <div class="footer-content">
                             <p>
                                 Catergo strävar efter att tillhandahålla seam-less lösningar och tjänster till våra
                                 kunder och minimerar insatserna för att beställa catering Quick Links Beställning
                             </p>
                 ...
                 <div class="col-xl-3 ps-lg-5 col-sm-6 col-md-4 col-lg-4 wow fadeInUp" data-wow-delay=".4s">
                     <div class="single-footer-widget">
                         <div class="widget-head">
                             <h4>Quick Links</h4>
                         </div>
                     ...
                     <div class="single-footer-widget">
                         ...
                         <div class="footer-apps-items">
                             ...
                             <div class="support-text">
                                 ...
                                 <h3><a href="tel:+ 08-640 244 00"> 08-640 244 00</a></h3>
                             </div>
                         </div>
                     </div>
                 </div>
