    ...
    <div class="container">
        <div class="main-cta-banner-wrapper bg-cover mt-10"
            ...
            <div class="arrow-shape">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/arrow-shape.png" alt="shape-img">
            </div>
            <div class="delivery-man">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/delivery-man.png" alt="img">
            </div>
            <div class="frame-shape">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/frame.png" alt="shape-img">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInUp" data-wow-delay=".4s">
                    <div class="booking-contact bg-cover"
                        style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/shape/booking-shape.png');">
