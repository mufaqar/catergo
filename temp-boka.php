...
<style>
    ...
    <section class="hero">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <p>Från gourmetburgare till vegansk streetfood – hitta den perfekta food trucken för ditt event, företagslunch eller privata fest. Över 50 verifierade food trucks, enkel bokning och leverans samma dag möjlig.</p>
            ...
            <div class="hero-image">
                <img src="https://images.unsplash.com/photo-1565123409695-7b5ef63a2efb?w=800&h=600&fit=crop&q=80" alt="Food truck i Stockholm serverar mat vid företagsevent">
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-content">
            ...
            <p>Food trucks har blivit den mest populära cateringlösningen i Stockholm för både företag och privatpersoner. Med en food truck får du inte bara fantastisk mat – du skapar en unik upplevelse som dina gäster kommer att minnas.</p>
            
            <p>Våra food trucks erbjuder professionell catering med en avslappnad och rolig atmosfär. Perfekt för allt från företagsluncher och kickoffer till bröllop, festivaler och privata fester. Mat tillagas färskt på plats vilket ger både autenticitet och kvalitet.</p>
            
            <h3>Fördelar med Food Truck Catering</h3>
            <p>Till skillnad från traditionell catering erbjuder food trucks en interaktiv upplevelse där gästerna kan se maten tillagas och välja precis vad de vill ha. Det skapar en mer avslappnad och social atmosfär som fungerar perfekt för både formella och informella evenemang.</p>
        </div>
    </section>
    ...
    <section class="section" id="trucks" style="background: var(--light-gray);">
        <div class="section-content">
            ...
            <p>Bläddra bland våra mest bokade food trucks. Alla leverantörer är noggrant utvalda och verifierade för att garantera högsta kvalitet.</p>
            
            <div class="truck-grid">
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
                        <div class="truck-cuisine">Gourmet Burgers</div>
                        <div class="truck-name">Street Gourmet Truck</div>
                        <div class="truck-description">Saftigaste burgarna i Stockholm med ekologiskt kött och hemlagade såser</div>
                ...
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
                ...
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
                        <div class="truck-cuisine">Vegansk Street Food</div>
                        <div class="truck-name">Green Wagon</div>
                        <div class="truck-description">100% växtbaserad gourmet som får även köttätare att förälska sig</div>
                        <div class="truck-rating">
                            <span class="stars">★★★★★</span>
                ...
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
                ...
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1562059392-096320bccc7e?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
                ...
                <div class="truck-card">
                    <div class="truck-image" style="background-image: url('https://images.unsplash.com/photo-1599974179-c0c74a2b0c5b?w=400&h=300&fit=crop&q=80')"></div>
                    <div class="truck-info">
        ...
        <div class="section-content">
            ...
            <div class="process-steps">
                <div class="step">
                    ...
                    <p>Bläddra bland våra verifierade food trucks och välj den som passar ditt event och din budget perfekt</p>
                </div>
                <div class="step">
    ...
    <section class="section pricing-section" id="priser">
        <div class="section-content">
            ...
            <p style="text-align: center; margin-top: 2rem; font-size: 0.95rem;">* Priserna är vägledande och varierar beroende på meny, dag och plats. Kontakta oss för exakt offert.</p>
        </div>
    </section>
            ...
            <div class="faq-list">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Att boka en food truck i Stockholm är enkelt med Catergo. Välj din önskade food truck från vårt urval, fyll i datum, plats och antal gäster. Välj meny och eventuella specialönskemål. Vi bekräftar din bokning inom 24 timmar och food trucken kommer i tid till ditt event.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Priserna för food trucks i Stockholm börjar från 2500 kr för mindre event och varierar beroende på antal gäster, meny och evenemangslängd. Genomsnittligt pris ligger på 150-250 kr per person. Vi erbjuder alltid transparent prissättning utan dolda avgifter. Kontakta oss för en exakt offert baserad på dina behov.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Vi rekommenderar att boka minst 2 veckor i förväg för att säkra din önskade food truck. För större evenemang eller bokningar under högsäsong (maj-september) bör du boka 1-2 månader i förväg. Sista minuten-bokningar kan ibland arrangeras beroende på tillgänglighet.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Vi levererar food trucks till hela Stockholmsområdet inklusive: Södermalm, Östermalm, Vasastan, Kungsholmen, Norrmalm, Bromma, Lidingö, Solna, Sundbyberg, Nacka, Huddinge och Täby. För platser utanför Stockholm stad kan en liten transportavgift tillkomma.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Ja! Alla våra food trucks kan anpassa menyer för olika dietbehov inklusive vegetariskt, veganskt, glutenfritt, laktosfritt, halal och kosher. Meddela oss i förväg om några gäster har allergier eller speciella dietkrav så ser vi till att alla får fantastisk mat.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Food trucks fungerar i alla väder! De flesta har tält eller överhäng där gäster kan stå skyddade. Vid extremt väder kan vi hjälpa dig hitta en alternativ lösning. Du kan alltid avboka upp till 7 dagar innan eventet utan kostnad vid dokumenterat oväder.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        De flesta food trucks är självförsörjande med egen generator och vattentank. För längre event (4+ timmar) uppskattas tillgång till el (230V, 16A) och vatten. Vi meddelar specifika krav när du bokar beroende på vilken food truck du väljer.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Absolut! För större event eller om du vill erbjuda variation rekommenderar vi att boka 2-3 olika food trucks med olika kök. Detta är populärt för företagsevent, festivaler och bröllop. Vi hjälper dig komponera det perfekta food truck-upplägget för ditt event.
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-section" id="boka">
        ...
        <p>Hitta den perfekta food trucken för ditt nästa event i Stockholm. Enkel bokning, transparenta priser och garanterad kvalitet.</p>
        <a href="#trucks" class="btn-white">Boka Food Truck Nu</a>
        <p style="margin-top: 2rem; font-size: 1rem; opacity: 0.9;">Eller ring oss på 08-XXX XXX XX för personlig rådgivning</p>
    </section>
